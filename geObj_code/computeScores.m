...
if nargin<4
    ...
    switch cue
        ...
        case 'MS' %Multi-scale Saliency
            ...
            for sid = 1:length(params.MS.scale) %looping over the scales
                ...
                min_width = max(1,round(params.min_window_width * scale/width));
                min_height = max(1,round(params.min_window_height * scale/height));
    ...
    switch cue                
        ...
        case 'CC'                         
            ...
            Q = computeQuantMatrix1(imgLAB,params.CC.quant);
...
%             I = imread(imgName);
            ...
            k = basis_k;
            N = EGBIS(I, sigma, k, int32(min_area));
